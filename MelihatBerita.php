...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="MelihatBerita.php">News</a>
                    </li>
    ...
    <div class="card">
        <h1 align="center"><?php echo $row['judul']; ?></h1>
        
            <div class="card-body">
            <img src="berita/<?php echo $row['gambar']; ?>" style="width: 540px;">
                <p> <?php echo $row['isi']; ?>
                </p>
